      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          {uploading ? (
            ...
            <div>
              <FileText
                size={36}
                className="mx-auto mb-4 dark:text-gray-600 text-gray-400"
              />
              ...
              <label
                className={`px-6 py-2.5 rounded-lg cursor-pointer transition-colors text-white text-sm font-medium ${
                  !isPro &&
                  remaining <= 0
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="relative flex-1">
            <Search
              size={14}
              className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-gray-400 text-gray-400"
            />
        ...
        {loading ? (
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <Skeleton
                key={i}
                className="h-16 w-full dark:bg-gray-800 bg-gray-100"
              />
            ))}
          </div>
              ...
              (paper) => (
                <div
                  ...
                  className={`dark:bg-gray-900 bg-gray-50 border dark:border-gray-800 border-gray-200 rounded-xl p-4 flex items-center justify-between ${
                    paper.status ===
                    'done'
                      ? 'cursor-pointer dark:hover:border-orange-500 hover:border-orange-400'
                      : ''
                  } transition-colors`}
                >
                  <div>
    ...
    <Suspense
      fallback={
        <div className="min-h-screen dark:bg-gray-950 bg-white flex items-center justify-center">
          <div className="animate-spin w-6 h-6 border-2 border-orange-500 border-t-transparent rounded-full rounded-full" />
        </div>
      }
    >
      <DashboardContent />
