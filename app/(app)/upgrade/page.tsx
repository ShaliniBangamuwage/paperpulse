  ...
  async function handleUpgrade() {
    ...
    try {
      ...
      if (data.url) {
        ...
        toast.info('Payment coming soon! This is a portfolio demo.')
      }
    } catch {
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        {isPro ? (
          <div className="text-center py-16">
            ...
            <p className="dark:text-gray-400 text-gray-500 mb-8">Enjoy unlimited papers and ideas.</p>
            <button
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              <div className="dark:bg-gray-900 bg-gray-50 border dark:border-gray-800 border-gray-200 rounded-2xl p-6">
                ...
                <p className="text-3xl font-bold mb-6">$0
              ...
              <div className="bg-orange-500 rounded-2xl p-6 relative overflow-hidden">
                ...
                <p className="text-3xl font-bold text-white mb-6">$9
