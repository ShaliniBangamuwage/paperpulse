...
// ✅ Removed: declare global Window payhere (not needed for form submit)
...
function UpgradePageInner() {
  ...
  // ✅ FIXED: pure form submit — no SDK, no popup, no JS errors
  async function handleUpgrade() {
    try {
      ...
      // ✅ Build and submit form — redirects entire page to PayHere
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        {isPro ? (
          <div className="text-center py-16">
            ...
            <h1 className="text-3xl font-bold mb-4 text-orange-500">You're on Pro!</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-8">Enjoy unlimited papers and ideas.</p>
            <button
          ...
          <>
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl font-bold mt-4 mb-4">Unlock full access</h1>
              <p className="text-lg text-gray-500 dark:text-gray-400">Keep generating ideas without limits</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6">
                ...
                <ul className="space-y-3 mb-6">
                  {['5 papers total', '15 ideas total', 'Basic library access', 'Save ideas'].map(f => (
                    <li key={f} className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-500">
              ...
              <div className="bg-orange-500 rounded-2xl p-6 relative overflow-hidden">
                ...
                <p className="text-3xl font-bold text-white mb-6">
                  $9<span className="text-base font-normal text-orange-100">/mo</span>
                </p>
                <ul className="space-y-3 mb-6">
                  {['Unlimited papers', 'Unlimited ideas', 'Priority processing', 'Share to library', 'Pro badge on profile', 'Early access to features'].map(f => (
                    <li key={f} className="flex items-center gap-2 text-sm text-white">✓ {f}</li>
                  ))}
                </ul>
                <button
